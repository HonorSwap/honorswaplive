...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@honorswap/uiex'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in HNR prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with HNR, win HNR if your numbers match')}
        </Text>
      </Flex>
