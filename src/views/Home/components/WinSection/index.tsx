...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@honorswap/uiex'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'HNR card' },
    { src: 'green', alt: 'Green HNR card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'HNR card' },
  ],
}
