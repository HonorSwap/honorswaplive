...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and HNR pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and HNR pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from HNR pool', data)
  }
