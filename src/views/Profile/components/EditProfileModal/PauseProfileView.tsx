...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@honorswap/uiex'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {t('Cost to reactivate in the future: %cost% HNR', { cost: formatBigNumber(numberCakeToReactivate) })}
      </Text>
