...
import { Heading, Text, Flex, ChevronRightIcon } from '@honorswap/uiex'
...
const Collectibles = () => {
  ...
  return (
    <>
      ...
      <Text as="p">
        {t('Pancake Collectibles are special ERC-721 NFTs that can be used on the HonorSwap platform.')}
      </Text>
      <Text as="p">
