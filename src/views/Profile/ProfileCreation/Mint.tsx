...
import { Card, CardBody, Heading, Text } from '@honorswap/uiex'
      ...
      <Card mb="24px">
        <CardBody>
          ...
          <Text as="p" mb="24px" color="textSubtle">
            {t('Cost: %num% HNR', { num: formatUnits(MINT_COST) })}
          </Text>
          {nfts.map((nft) => {
          ...
          {!hasMinimumCakeRequired && (
            <Text color="failure" mb="16px">
              {t('A minimum of %num% HNR is required', { num: formatUnits(MINT_COST) })}
            </Text>
          )}
